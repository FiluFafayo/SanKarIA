                                                                                              ...
                                                                                              <h3 className="text-lg font-bold mb-2">Pemain di Sesi Ini:</h3>
                                                                                                    <ul className="flex gap-2 mb-4">
                                                                                                            {sessionData.players.map(playerId => (
                                                                                                                      <li key={playerId} className="bg-gray-700 text-xs px-2 py-1 rounded-full" title={playerId}>
                                                                                                                                                                               ...
                                                                                                                                                                               {sessionData.gameState.chatLog.map((msg, index) => (
                                                                                                                                                                                         <div key={index} className="mb-2">
                                                                                                                                                                                                     <p className={`p-2 rounded-lg text-sm ${
                                                                                                                                                                                                                   msg.sender === 'system' ? 'bg-yellow-800 text-yellow-200' : 'bg-gray-700'
                                                                                                                                                                                                                               }`}>
                                                                                                                                                                                                                                             {msg.text}
                                                                                                                                                                                                                                                         </p>
                                                                                                                                                                                                                                                                   </div>
                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                       <div className="flex bg-gray-700 rounded-b-lg p-2">
                                                                                                                                                                                                                                                                                               <input type="text" className="flex-grow bg-gray-800 rounded-l-md p-2 focus:outline-none" placeholder="Kirim pesan..." />
                                                                                                                                                                                                                                                                                                       <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-4 rounded-r-md">Kirim</button>
                                                                                                                                                                                                                                                                                                             </div>
                                                                                                                                                                                                                                                                                                                 </div>
                                                                                                                                                                                                                                                                                                                   );
                                                                                                                                                                                                                                                                                                                   }
