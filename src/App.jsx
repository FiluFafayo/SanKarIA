    ...
    >
      ...
      <div className="relative z-10 text-center container mx-auto">
        ...
        <main className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div onClick={() => setActiveModal('TerminalLintas')} className="border-2 border-gray-500 rounded-lg p-6 bg-black bg-opacity-50 hover:bg-opacity-75 transition-all cursor-pointer">
